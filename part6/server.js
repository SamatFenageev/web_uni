...
mongoose.connect('mongodb://0.0.0.0:27017/web_kai', { useNewUrlParser: true, useUnifiedTopology: true })  // Подключаемся к БД
...
let Ad = mongoose.model('Ad', new Schema({ description: String, tags: [ String ] })); // Создаем модель данных

app.use(express.static(__dirname + "/client"));
http.createServer(app).listen(3000);

app.get("/ads.json", async (req, res) => { // Настраиваем маршрутизатор для GET-запроса
...
app.post("/ads", async (req, res) => { // Настроиваем маршрутизатор для POST-запроса
